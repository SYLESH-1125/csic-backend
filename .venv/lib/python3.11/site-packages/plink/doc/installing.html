...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Installing and running PLink &#8212; PLink 2.4.8 documentation</title>
...
<h1>Installing and running PLink<a class="headerlink" href="#installing-and-running-plink" title="Link to this heading">¶</a></h1>
<section id="mac-os-x">
...
<hr class="docutils" />
<p>You will need to have Python (&gt; 2.4), Tk (&gt;= 8.4), and Tkinter
installed to run plink; for instance, if you are using Debian or
Ubuntu, just install the package “python-tk”.</p>
<p>If you have root privileges and <a class="reference external" href="https://pip.pypa.io/en/latest/">pip</a>, simply do:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">pip</span> <span class="n">install</span> <span class="n">plink</span>
</pre></div>
</div>
