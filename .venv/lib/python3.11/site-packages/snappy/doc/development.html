...
<head>
  ...
  <title>Development Basics &mdash; SnapPy 3.3.1 documentation</title>
...
<li><p>In the unlikely event you want to build <a class="reference external" href="https://github.com/3-manifolds/CyPari">CyPari</a> from source, you’ll need
<a class="reference external" href="http://msys2.github.io">MSYS2</a>.  Follow the instructions on the
webpage to update everything to the very latest MSYS2 (<code class="docutils literal notranslate"><span class="pre">pacman</span> <span class="pre">-Sy</span>
<span class="pre">pacman;</span> <span class="pre">pacman</span> <span class="pre">-Syu;</span> <span class="pre">pacman</span> <span class="pre">-Su</span></code> etc.).  You should also install
the ucrt toolchain:</p>
...
<span class="n">python</span> <span class="o">-</span><span class="n">m</span> <span class="n">pip</span> <span class="n">install</span> <span class="n">sphinx</span> <span class="n">cython</span> <span class="n">cypari</span> <span class="n">pyx</span> <span class="n">FXrays</span> <span class="n">low_index</span>
</pre></div>
</div>
</li>
