...
<head>
  ...
  <title>Screenshots: SnapPy in action &mdash; SnapPy 3.3.1 documentation</title>
    ...
    <link rel="prev" title="Installing SnapPy" href="installing.html" /> 
</head>
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Screenshots: SnapPy in action</a><ul>
<li class="toctree-l2"><a class="reference internal" href="#mac-os-x">Mac OS X</a></li>
<li class="toctree-l2"><a class="reference internal" href="#linux-ubuntu-13-10">Linux (Ubuntu 13.10)</a></li>
<li class="toctree-l2"><a class="reference internal" href="#windows-7">Windows 7</a></li>
</ul>
</li>
...
<li class="toctree-l1"><a class="reference internal" href="development.html">Development Basics</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">Screenshots: SnapPy in action</li>
  ...
  <section id="screenshots-snappy-in-action">
<h1>Screenshots: SnapPy in action<a class="headerlink" href="#screenshots-snappy-in-action" title="Link to this heading"></a></h1>
<section id="mac-os-x">
<h2>Mac OS X<a class="headerlink" href="#mac-os-x" title="Link to this heading"></a></h2>
<a class="reference internal image-reference" href="_images/mac.png"><img alt="_images/mac.png" src="_images/mac.png" style="width: 717px;" />
</a>
</section>
<section id="linux-ubuntu-13-10">
<h2>Linux (Ubuntu 13.10)<a class="headerlink" href="#linux-ubuntu-13-10" title="Link to this heading"></a></h2>
<img alt="_images/ubuntu.png" src="_images/ubuntu.png" />
</section>
<section id="windows-7">
<h2>Windows 7<a class="headerlink" href="#windows-7" title="Link to this heading"></a></h2>
<img alt="_images/win7.png" src="_images/win7.png" />
        ...
        <a href="installing.html" class="btn btn-neutral float-left" title="Installing SnapPy" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
