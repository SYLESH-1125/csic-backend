...
<head>
  ...
  <title>Manifold: the main class &mdash; SnapPy 3.3.1 documentation</title>
...
<li class="toctree-l4"><a class="reference internal" href="#snappy.Manifold.fox_milnor_test"><code class="docutils literal notranslate"><span class="pre">Manifold.fox_milnor_test()</span></code></a></li>
...
<li class="toctree-l4"><a class="reference internal" href="#snappy.Manifold.margulis"><code class="docutils literal notranslate"><span class="pre">Manifold.margulis()</span></code></a></li>
...
<em class="property"><span class="k"><span class="pre">class</span></span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">snappy.</span></span><span class="sig-name descname"><span class="pre">Manifold</span></span><a class="headerlink" href="#snappy.Manifold" title="Link to this definition"></a></dt>
...
<span class="gp">&gt;&gt;&gt; </span><span class="n">accuracy</span> <span class="ow">in</span> <span class="p">(</span><span class="mi">8</span><span class="p">,</span> <span class="mi">9</span><span class="p">,</span> <span class="mi">56</span><span class="p">,</span> <span class="mi">57</span><span class="p">)</span> <span class="c1"># Low and High precision</span>
<span class="go">True</span>
</pre></div>
</div>
...
<dl class="py method">
<dt class="sig sig-object py" id="snappy.Manifold.fox_milnor_test">
<span class="sig-name descname"><span class="pre">fox_milnor_test</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#snappy.Manifold.fox_milnor_test" title="Link to this definition"></a></dt>
...
<dd><p>The entries of the matrices of the holonomy representation as list
...
<code class="xref py py-attr docutils literal notranslate"><span class="pre">max_len</span></code> is also given, the result contains either the
<code class="xref py py-attr docutils literal notranslate"><span class="pre">count</span></code> shortest geodesics or all geodesics shorter than
<code class="xref py py-attr docutils literal notranslate"><span class="pre">max_len</span></code> (and maybe additional geodesics).</p></li>
...
geodesics. See <code class="xref py py-attr docutils literal notranslate"><span class="pre">count</span></code> when used with <code class="xref py py-attr docutils literal notranslate"><span class="pre">count</span></code>.</p></li>
...
<span class="sig-name descname"><span class="pre">length_spectrum_alt_gen</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">bits_prec</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">int</span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">verified</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">bool</span></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">False</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">include_intermediates</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">bool</span></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">False</span></span></em><span class="sig-paren">)</span> <span class="sig-return"><span class="sig-return-icon">&#x2192;</span> <span class="sig-return-typehint"><span class="pre">Sequence</span><span class="p"><span class="pre">[</span></span><span class="pre">LengthSpectrumGeodesicInfo</span><span class="p"><span class="pre">]</span></span></span></span><a class="headerlink" href="#snappy.Manifold.length_spectrum_alt_gen" title="Link to this definition"></a></dt>
...
not succeed.</p></li>
<li><p><strong>verified</strong> – Use <a class="reference internal" href="verify.html#verify-primer"><span class="std std-ref">verified computation</span></a>.</p></li>
<li><p><strong>include_intermediates</strong> – For advanced users, add intermediate lower bounds to the stream.
...
occurred in the stream. When <code class="docutils literal notranslate"><span class="pre">verified=True</span></code>, the size of the
intervals might fluctate and the left endpoint is not guaranteed
to be non-decreasing.</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="snappy.Manifold.margulis">
<span class="sig-name descname"><span class="pre">margulis</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">bits_prec</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">int</span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">verified</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">bool</span></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">False</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">include_thin_part</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">bool</span></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">False</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">stopper</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#snappy.Manifold.margulis" title="Link to this definition"></a></dt>
<dd><p>Returns the optimal Margulis number <span class="math notranslate nohighlight">\(\mu(M)\)</span>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">Manifold</span><span class="p">(</span><span class="s2">&quot;m004&quot;</span><span class="p">)</span><span class="o">.</span><span class="n">margulis</span><span class="p">()</span>
<span class="go">0.962423650119202</span>
</pre></div>
</div>
<p>If <code class="xref py py-attr docutils literal notranslate"><span class="pre">include_thin_part=True</span></code>, returns a triple
(<span class="math notranslate nohighlight">\(\mu(M)\)</span>, <span class="math notranslate nohighlight">\(\mu(M)\)</span>-thin part, collisions). Recall that the
<span class="math notranslate nohighlight">\(\mu(M)\)</span>-thin part is the union of all essential loops of length
less than <span class="math notranslate nohighlight">\(\mu(M)\)</span>. It is a disjoint union of embedded cusp
...
tubes are touching:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">Manifold</span><span class="p">(</span><span class="s2">&quot;m003&quot;</span><span class="p">)</span><span class="o">.</span><span class="n">margulis</span><span class="p">(</span><span class="n">include_thin_part</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
<span class="go">(0.962423650119189,</span>
<span class="go"> [Cusp Neighborhood for cusp 0 of area 0.866025403784405,</span>
<span class="go">  Tube about geodesic aC of radius 0.211824465096784,</span>
<span class="go">  Tube about geodesic a of radius 0.211824465096782,</span>
<span class="go">  Tube about geodesic bC of radius 0.211824465096782,</span>
<span class="go">  Tube about geodesic b of radius 0.211824465096782],</span>
<span class="go"> [(2, 3), (1, 4)])</span>
</pre></div>
</div>
<p>Note that the method fails on some manifolds with incomplete cusps
such as <code class="docutils literal notranslate"><span class="pre">s479(-3,1)</span></code> where the boundary of the thin part is intersecting
a core curve. In such cases (or in order to improve performance), we can
use <code class="xref py py-attr docutils literal notranslate"><span class="pre">stopper</span></code> to show that <span class="math notranslate nohighlight">\(\mu(M)\)</span> is larger than a given
number. Here is an example to prove that <span class="math notranslate nohighlight">\(\mu(M)&gt;0.8\)</span>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">sage</span><span class="p">:</span> <span class="n">M</span><span class="o">=</span><span class="n">ManifoldHP</span><span class="p">(</span><span class="s2">&quot;s479(-3,1)&quot;</span><span class="p">)</span>
<span class="n">sage</span><span class="p">:</span> <span class="kn">from</span> <span class="nn">snappy.sage_helper</span> <span class="kn">import</span> <span class="n">RealIntervalField</span>
<span class="n">sage</span><span class="p">:</span> <span class="n">M</span><span class="o">.</span><span class="n">margulis</span><span class="p">(</span><span class="n">verified</span><span class="o">=</span><span class="kc">True</span><span class="p">,</span> <span class="n">stopper</span><span class="o">=</span><span class="mf">0.9</span><span class="p">)</span><span class="o">&gt;</span><span class="n">RealIntervalField</span><span class="p">()(</span><span class="s1">&#39;0.8&#39;</span><span class="p">)</span>
<span class="kc">True</span>
</pre></div>
</div>
<p><strong>Verified computations</strong></p>
<p>The method also supports <a class="reference internal" href="verify.html#verify-primer"><span class="std std-ref">verified computations</span></a>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>sage: Manifold(&quot;m003&quot;).margulis(verified=True,bits_prec=100) # doctest: +NUMERIC15
0.9624236501192068949955?
</pre></div>
</div>
<p>If <code class="xref py py-attr docutils literal notranslate"><span class="pre">verified=True</span></code> and <code class="xref py py-attr docutils literal notranslate"><span class="pre">include_thin_part=True</span></code> are used
...
geodesic of real length equal to (or really close to) <span class="math notranslate nohighlight">\(\mu(M)\)</span>.
Numerically, we cannot decide whether the limiting constituent of
<span class="math notranslate nohighlight">\(\mu(M)\)</span> is the geodesic or some other neighborhood or pair of
...
not succeed.</p></li>
<li><p><strong>verified</strong> – Use <a class="reference internal" href="verify.html#verify-primer"><span class="std std-ref">verified computation</span></a>.</p></li>
<li><p><strong>include_thin_part</strong> – Return triple
(<span class="math notranslate nohighlight">\(\mu(M)\)</span>, <span class="math notranslate nohighlight">\(\mu(M)\)</span>-thin part, collisions) instead
of only the optimal Margulis number <span class="math notranslate nohighlight">\(\mu(M)\)</span>.</p></li>
<li><p><strong>stopper</strong> – Return the minimum of <code class="xref py py-attr docutils literal notranslate"><span class="pre">stopper</span></code> and the optimal Margulis
number <span class="math notranslate nohighlight">\(\mu(M)\)</span> (and the corresponding thin part if
<code class="xref py py-attr docutils literal notranslate"><span class="pre">include_thin_part=True</span></code>).</p></li>
</ul>
</dd>
<dt class="field-even">Returns<span class="colon">:</span></dt>
<dd class="field-even"><p>Optimal Margulis number <span class="math notranslate nohighlight">\(\mu(M)\)</span> or triple
(<span class="math notranslate nohighlight">\(\mu(M)\)</span>, <span class="math notranslate nohighlight">\(\mu(M)\)</span>-thin part, collisions).</p>
</dd>
</dl>
</dd></dl>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">sage</span><span class="p">:</span> <span class="kn">from</span> <span class="nn">sage.symbolic.constants</span> <span class="kn">import</span> <span class="n">pi</span>
...
is.  If the flag <code class="xref py py-attr docutils literal notranslate"><span class="pre">enum=True</span></code> is set, then an integer value is
returned. The possible answers are:</p>
<ul>
<li><p>0: <code class="docutils literal notranslate"><span class="pre">not</span> <span class="pre">attempted</span></code></p></li>
<li><p>1: <code class="docutils literal notranslate"><span class="pre">all</span> <span class="pre">tetrahedra</span> <span class="pre">positively</span> <span class="pre">oriented</span></code> aka <em>geometric_solution</em></p>
<p>Should correspond to a genuine hyperbolic structure.</p>
</li>
<li><p>2: <code class="docutils literal notranslate"><span class="pre">contains</span> <span class="pre">negatively</span> <span class="pre">oriented</span> <span class="pre">tetrahedra</span></code> aka <em>nongeometric solution</em></p>
<p>Probably corresponds to a hyperbolic structure but some
simplices have reversed orientations.</p>
</li>
<li><p>3: <code class="docutils literal notranslate"><span class="pre">contains</span> <span class="pre">flat</span> <span class="pre">tetrahedra</span></code> (should be called <code class="docutils literal notranslate"><span class="pre">all</span> <span class="pre">tetrahedra</span> <span class="pre">flat</span></code>)</p>
<p>All tetrahedra have shape in <span class="math notranslate nohighlight">\(\mathbb{R} - \{0, 1\}\)</span>.</p>
</li>
<li><p>4: <code class="docutils literal notranslate"><span class="pre">contains</span> <span class="pre">degenerate</span> <span class="pre">tetrahedra</span></code></p>
<p>Some shapes are close to <span class="math notranslate nohighlight">\(\{0,1, \infty\}\)</span>.</p>
</li>
<li><p>5: <code class="docutils literal notranslate"><span class="pre">unrecognized</span> <span class="pre">solution</span> <span class="pre">type</span></code></p></li>
<li><p>6: <code class="docutils literal notranslate"><span class="pre">no</span> <span class="pre">solution</span> <span class="pre">found</span></code></p></li>
</ul>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">M</span> <span class="o">=</span> <span class="n">Manifold</span><span class="p">(</span><span class="s1">&#39;m007&#39;</span><span class="p">)</span>
...
<em class="property"><span class="k"><span class="pre">classmethod</span></span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">use_field_conversion</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">func</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#snappy.Manifold.use_field_conversion" title="Link to this definition"></a></dt>
