...
<head>
  ...
  <title>Census manifolds &mdash; SnapPy 3.3.1 documentation</title>
...
<li class="toctree-l3"><a class="reference internal" href="#snappy.RibbonLinks"><code class="docutils literal notranslate"><span class="pre">RibbonLinks</span></code></a></li>
...
page.</p>
<p>SnapPy’s iterators support several flexible methods for accessing
...
<a class="reference external" href="https://arXiv.org/abs/2512.02142">[Li]</a> for background on
these manifolds.</p>
...
<span class="gp">...</span>
<span class="go">o10_150721(0,0)(0,0)(0,0) 10.1494160640965</span>
<span class="go">o10_150722(0,0)(0,0)(0,0) 10.1494160640965</span>
<span class="go">o10_150723(0,0)(0,0) 10.1494160640965</span>
...
<span class="go">m129(0,0)(0,0) 3.66386238 2</span>
<span class="go">m202(0,0)(0,0) 4.05976643 2</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">M</span> <span class="o">=</span> <span class="n">Manifold</span><span class="p">(</span><span class="s1">&#39;m129&#39;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">M</span> <span class="ow">in</span> <span class="n">LinkExteriors</span>
<span class="go">True</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">LinkExteriors</span><span class="o">.</span><span class="n">identify</span><span class="p">(</span><span class="n">M</span><span class="p">)</span>
<span class="go">5^2_1(0,0)(0,0)</span>
</pre></div>
</div>
</dd></dl>
...
<span class="go">11031</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">len</span><span class="p">(</span><span class="n">OrientableClosedCensus</span><span class="p">(</span><span class="n">betti</span><span class="o">=</span><span class="mi">2</span><span class="p">))</span>
<span class="go">1</span>
<span class="gp">&gt;&gt;&gt; </span><span class="k">for</span> <span class="n">M</span> <span class="ow">in</span> <span class="n">OrientableClosedCensus</span><span class="p">(</span><span class="n">betti</span><span class="o">=</span><span class="mi">2</span><span class="p">):</span>
...
<span class="gp">...</span>
<span class="go">v1539(5,1) Z + Z</span>
</pre></div>
</div>
</dd></dl>
...
<a class="reference external" href="https://arXiv.org/abs/2512.02142">[Li]</a> for more.</p>
...
<span class="go">K5_1(0,0) 3.41791484 False</span>
<span class="go">K5_2(0,0) 3.42720525 8_1(0,0)</span>
<span class="go">K5_3(0,0) 3.48666015 9_2(0,0)</span>
</pre></div>
</div>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">len</span><span class="p">(</span><span class="n">CensusKnots</span><span class="p">)</span>
<span class="go">3116</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">CensusKnots</span><span class="p">[</span><span class="o">-</span><span class="mi">1</span><span class="p">]</span><span class="o">.</span><span class="n">num_tetrahedra</span><span class="p">()</span>
...
<span class="go">10^3_73(0,0)(0,0)(0,0) 15.86374431</span>
<span class="go">10^3_74(0,0)(0,0)(0,0) 15.55091438</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">M</span> <span class="o">=</span> <span class="n">Manifold</span><span class="p">(</span><span class="s1">&#39;8_4&#39;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">OrientableCuspedCensus</span><span class="o">.</span><span class="n">identify</span><span class="p">(</span><span class="n">M</span><span class="p">)</span>
<span class="go">s862(0,0)</span>
</pre></div>
</div>
<p>By default, the ‘identify’ returns the first isometric manifold it finds;
if the optional ‘extends_to_link’ flag is set, it insists that meridians
are taken to meridians.</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">M</span> <span class="o">=</span> <span class="n">Manifold</span><span class="p">(</span><span class="s1">&#39;7^2_8&#39;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">LinkExteriors</span><span class="o">.</span><span class="n">identify</span><span class="p">(</span><span class="n">M</span><span class="p">)</span>
<span class="go">5^2_1(0,0)(0,0)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">LinkExteriors</span><span class="o">.</span><span class="n">identify</span><span class="p">(</span><span class="n">M</span><span class="p">,</span> <span class="n">extends_to_link</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
<span class="go">7^2_8(0,0)(0,0)</span>
</pre></div>
</div>
</dd></dl>
...
number.</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">HTLinkExteriors</span><span class="o">.</span><span class="n">identify</span><span class="p">(</span><span class="n">LinkExteriors</span><span class="p">[</span><span class="s1">&#39;8_20&#39;</span><span class="p">])</span>
<span class="go">K8n1(0,0)</span>
...
<span class="go">L12n1097 2 8.51918360</span>
<span class="go">L14n13364 2 8.69338342</span>
<span class="go">L14n13513 2 8.58439465</span>
<span class="go">L14n15042 2 8.66421454</span>
<span class="go">L14n24425 2 8.60676092</span>
<span class="go">L14n24777 2 8.53123093</span>
<span class="go">L14n26042 2 8.64333782</span>
<span class="gp">&gt;&gt;&gt; </span><span class="k">for</span> <span class="n">L</span> <span class="ow">in</span> <span class="n">Mylist</span><span class="p">:</span>
<span class="gp">... </span>  <span class="nb">print</span><span class="p">(</span> <span class="n">L</span><span class="o">.</span><span class="n">name</span><span class="p">(),</span> <span class="n">L</span><span class="o">.</span><span class="n">DT_code</span><span class="p">()</span> <span class="p">)</span>
<span class="gp">...</span>
<span class="go">L11n138 [(8, -10, -12), (6, -16, -18, -22, -20, -2, -4, -14)]</span>
<span class="go">L12n1097 [(10, 12, -14, -18), (22, 2, -20, 24, -6, -8, 4, 16)]</span>
<span class="go">L14n13364 [(8, -10, 12), (6, -18, 20, -22, -26, -24, 2, -4, -28, -16, -14)]</span>
<span class="go">L14n13513 [(8, -10, 12), (6, -20, 18, -26, -24, -4, 2, -28, -16, -14, -22)]</span>
<span class="go">L14n15042 [(8, -10, 14), (12, -16, 18, -22, 24, 2, 26, 28, 6, -4, 20)]</span>
<span class="go">L14n24425 [(10, -12, 14, -16), (-18, 26, -24, 22, -20, -28, -6, 4, -2, 8)]</span>
<span class="go">L14n24777 [(10, 12, -14, -18), (2, 28, -22, 24, -6, 26, -8, 4, 16, 20)]</span>
<span class="go">L14n26042 [(10, 12, 14, -20), (8, 2, 28, -22, -24, -26, -6, -16, -18, 4)]</span>
</pre></div>
</div>
<p>SnapPy comes with one of two versions of HTLinkExteriors.  The
smaller original one provides knots and links up to 14
crossings; the larger adds to that the knots (but not links)
with 15 crossings.  You can determine which you have by whether</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">len</span><span class="p">(</span><span class="n">HTLinkExteriors</span><span class="p">(</span><span class="n">crossings</span><span class="o">=</span><span class="mi">15</span><span class="p">))</span>
</pre></div>
</div>
<p>gives 0 or 253293. To upgrade to the larger database, install
the Python module ‘snappy_15_knots’ as discussed on the
‘installing SnapPy’ webpage.</p>
</dd></dl>

<dl class="py data">
<dt class="sig sig-object py" id="snappy.RibbonLinks">
<span class="sig-prename descclassname"><span class="pre">snappy.</span></span><span class="sig-name descname"><span class="pre">RibbonLinks</span></span><em class="property"><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">RibbonLinks</span> <span class="pre">without</span> <span class="pre">filters</span></em><a class="headerlink" href="#snappy.RibbonLinks" title="Link to this definition"></a></dt>
<dd><p>The database of ribbon links from Section 2.5 of <a class="reference external" href="https://arXiv.org/abs/2512.21825">[Dunfield
and Gong]</a>.  Each link
includes a certificate describing the ribbon disks:</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">len</span><span class="p">(</span><span class="n">RibbonLinks</span><span class="p">(</span><span class="n">cusps</span><span class="o">=</span><span class="mi">2</span><span class="p">))</span>
<span class="go">12143</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">M</span> <span class="o">=</span> <span class="n">RibbonLinks</span><span class="p">[</span><span class="mi">1000</span><span class="p">]</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">M</span><span class="o">.</span><span class="n">name</span><span class="p">(),</span> <span class="n">M</span><span class="o">.</span><span class="n">num_cusps</span><span class="p">(),</span> <span class="n">M</span><span class="o">.</span><span class="n">volume</span><span class="p">()</span>
<span class="go">(&#39;ribbon_2_16_3079d007&#39;, 2, 22.9002274714046)</span>
</pre></div>
</div>
<p>The bands used show each link is ribbon are included.  For this link,
we used 3 bands:</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">N</span> <span class="o">=</span> <span class="n">RibbonLinks</span><span class="p">[</span><span class="s1">&#39;ribbon_2_23_f9c7aff2&#39;</span><span class="p">]</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">N</span><span class="o">.</span><span class="n">ribbon_cert</span><span class="p">[</span><span class="mi">1</span><span class="p">::</span><span class="mi">2</span><span class="p">]</span>
<span class="go">[&#39;0d1c54_1_0&#39;, &#39;5e5709_1_0&#39;, &#39;144f625e5d29_5_2&#39;]</span>
</pre></div>
</div>
</dd></dl>
...
<span class="gp">... </span>  <span class="nb">print</span><span class="p">(</span><span class="n">M</span><span class="p">,</span> <span class="n">M</span><span class="o">.</span><span class="n">homology</span><span class="p">())</span>
<span class="gp">...</span>
<span class="go">m124(0,0)(0,0)(0,0) Z/2 + Z + Z</span>
<span class="go">m128(0,0)(0,0) Z + Z</span>
<span class="go">m131(0,0) Z + Z</span>
</pre></div>
</div>
</dd></dl>
...
<span class="go">m153(1,0) 2.66674478</span>
</pre></div>
</div>
</dd></dl>
...
<ul>
<li class="toctree-l1"><a class="reference internal" href="platonic_census.html">Censuses of Platonic manifolds</a></li>
</ul>
</div>
<p>As instances of subclasses of ManifoldTable, the objects above
support the following methods.</p>
<dl class="py class">
<dt class="sig sig-object py" id="snappy.database.ManifoldTable">
<em class="property"><span class="k"><span class="pre">class</span></span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">snappy.database.</span></span><span class="sig-name descname"><span class="pre">ManifoldTable</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">table=''</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">db_path=None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">mfld_hash=&lt;function</span> <span class="pre">mfld_hash&gt;</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">**filter_args</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#snappy.database.ManifoldTable" title="Link to this definition"></a></dt>
...
M._to_string().</p>
<p>Both mapping from the manifold name, and lookup by index are
supported.  Slicing can be done either by numerical index or by
volume.</p>
<p>The __contains__ method is supported, so M in T returns True if M
...
declares to be isometric.</p>
<p>Return False if no manifold in the table has the same hash.</p>
<p>Return None in all other cases (for now).</p>
<p>If the flag “extends_to_link” is True, requires that the isometry
sends meridians to meridians.   If the input manifold is closed
this will result in no matches being returned.</p>
</dd></dl>
...
<p>Because of the large size of their datasets, the classes below
...
<em class="property"><span class="k"><span class="pre">class</span></span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">snappy.</span></span><span class="sig-name descname"><span class="pre">NonalternatingKnotExteriors</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">indices</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">(0,</span> <span class="pre">1210608,</span> <span class="pre">1)</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#snappy.NonalternatingKnotExteriors" title="Link to this definition"></a></dt>
