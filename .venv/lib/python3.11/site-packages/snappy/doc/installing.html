...
<head>
  ...
  <title>Installing SnapPy &mdash; SnapPy 3.3.1 documentation</title>
...
variety of platforms.  The current version is 3.3.1 which was released
on February 2026.  If you encounter any problems installing SnapPy,
...
<p>Starting with SnapPy 3.2, you can install snappy on Linux by downloading
<a class="reference external" href="https://github.com/3-manifolds/SnapPy/releases/latest/download/SnapPy-x86_64.AppImage">SnapPy-x86_64.AppImage</a>, which is a completely self-contained SnapPy <a class="reference external" href="https://docs.appimage.org/introduction/quickstart.html#ref-quickstart">AppImage</a>
that should work on any Linux system from the last 5 years.</p>
<p>After downloading the AppImage, follow the recipe below:</p>
...
<p>The AppImage contains its own private copy of Python, so if
you plan to use SnapPy in your own Python programs, skip ahead to
<a class="reference internal" href="#python-modules-for-linux">Python Modules for Linux</a>.</p>
</section>
...
<p>The complete source code for all platforms: <a class="reference external" href="https://pypi.python.org/packages/source/s/snappy/snappy-3.3.1.tar.gz">snappy-3.3.1.tar.gz</a></p>
