...
<head>
  ...
  <title>ManifoldHP: High-precision variant &mdash; SnapPy 3.3.1 documentation</title>
...
<h1>ManifoldHP: High-precision variant<a class="headerlink" href="#manifoldhp-high-precision-variant" title="Link to this heading"></a></h1>
