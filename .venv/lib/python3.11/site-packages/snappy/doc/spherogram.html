...
<head>
  ...
  <title>Links: planar diagrams and invariants &mdash; SnapPy 3.3.1 documentation</title>
...
<li class="toctree-l4"><a class="reference internal" href="#spherogram.Link.add_band"><code class="docutils literal notranslate"><span class="pre">Link.add_band()</span></code></a></li>
...
<li class="toctree-l4"><a class="reference internal" href="#spherogram.Link.bridge_upper_bound"><code class="docutils literal notranslate"><span class="pre">Link.bridge_upper_bound()</span></code></a></li>
...
<li class="toctree-l4"><a class="reference internal" href="#spherogram.Link.many_diagrams"><code class="docutils literal notranslate"><span class="pre">Link.many_diagrams()</span></code></a></li>
...
<li class="toctree-l4"><a class="reference internal" href="#spherogram.Link.ribbon_concordant_links"><code class="docutils literal notranslate"><span class="pre">Link.ribbon_concordant_links()</span></code></a></li>
...
<em class="property"><span class="k"><span class="pre">class</span></span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">spherogram.</span></span><span class="sig-name descname"><span class="pre">Link</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">crossings</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">braid_closure</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">check_planarity</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">build</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#spherogram.Link" title="Link to this definition"></a></dt>
...
<dl class="py method">
<dt class="sig sig-object py" id="spherogram.Link.add_band">
<span class="sig-name descname"><span class="pre">add_band</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">band</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#spherogram.Link.add_band" title="Link to this definition"></a></dt>
<dd><p>Adds the specified band to the link and returns the result,
...
<a class="reference external" href="https://arXiv.org/abs/2512.21825">[Dunfield and Gong]</a>
for how the band is specified.  Typically, the user invokes
<a class="reference internal" href="#spherogram.Link.ribbon_concordant_links" title="spherogram.Link.ribbon_concordant_links"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Link.ribbon_concordant_links()</span></code></a> rather than use this
method directly.</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">K</span> <span class="o">=</span> <span class="n">Link</span><span class="p">(</span><span class="s1">&#39;K6a3&#39;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">band</span> <span class="o">=</span> <span class="p">([(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">0</span><span class="p">),</span> <span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">1</span><span class="p">),</span> <span class="p">(</span><span class="mi">3</span><span class="p">,</span> <span class="mi">0</span><span class="p">)],</span> <span class="p">[</span><span class="kc">True</span><span class="p">],</span> <span class="mi">1</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">L</span> <span class="o">=</span> <span class="n">K</span><span class="o">.</span><span class="n">add_band</span><span class="p">(</span><span class="n">band</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">L</span><span class="o">.</span><span class="n">simplify</span><span class="p">(</span><span class="s1">&#39;global&#39;</span><span class="p">)</span>
<span class="go">True</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">L</span>
<span class="go">&lt;Link K6a3+band: 0 comp; 0 cross&gt;</span>
</pre></div>
</div>
</dd></dl>
...
<dl class="py method">
<dt class="sig sig-object py" id="spherogram.Link.bridge_upper_bound">
<span class="sig-name descname"><span class="pre">bridge_upper_bound</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">method</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">'plain</span> <span class="pre">sphere'</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">return_meridians</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">False</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#spherogram.Link.bridge_upper_bound" title="Link to this definition"></a></dt>
<dd><p>Computes an upper bound on the bridge number of the given link.
By default, it computes the plain sphere number rho(D) of the
diagram D from <a class="reference internal" href="#bkp2025" id="id2"><span>[BKP2025]</span></a>, but with <code class="docutils literal notranslate"><span class="pre">method='wirtinger'</span></code>, it
computes the weaker Wirtinger number omega(D) from <a class="reference internal" href="#bkvv2020" id="id3"><span>[BKVV2020]</span></a>.
The latter is significantly faster to compute.</p>
<p>If <code class="docutils literal notranslate"><span class="pre">return_meridians=True</span></code> is set, returns a list of meridians
generating the knot group, where each meridian is specified by the
index of the crossing for which it is the 0 input strand.</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">K</span> <span class="o">=</span> <span class="n">Link</span><span class="p">(</span><span class="s1">&#39;14n1527&#39;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">K</span><span class="o">.</span><span class="n">bridge_upper_bound</span><span class="p">()</span>
<span class="go">3</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">K</span><span class="o">.</span><span class="n">bridge_upper_bound</span><span class="p">(</span><span class="n">method</span><span class="o">=</span><span class="s1">&#39;wirtinger&#39;</span><span class="p">)</span>
<span class="go">4</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">K</span><span class="o">.</span><span class="n">bridge_upper_bound</span><span class="p">(</span><span class="n">return_meridians</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
<span class="go">[2, 3, 9]</span>
</pre></div>
</div>
<div role="list" class="citation-list">
<div class="citation" id="bkp2025" role="doc-biblioentry">
<span class="label"><span class="fn-bracket">[</span><a role="doc-backlink" href="#id2">BKP2025</a><span class="fn-bracket">]</span></span>
<p>R. Blair, A. Kjuchukova, and E. Pfaff,
<em>The Plain Sphere Number of a Link.</em>
<a class="reference external" href="https://arxiv.org/abs/2504.10517">https://arxiv.org/abs/2504.10517</a></p>
</div>
<div class="citation" id="bkvv2020" role="doc-biblioentry">
<span class="label"><span class="fn-bracket">[</span><a role="doc-backlink" href="#id3">BKVV2020</a><span class="fn-bracket">]</span></span>
<p>R. Blair, A. Kjuchukova, R. Velazquez, and P. Villanueva,
<em>Wirtinger systems of generators of knot groups.</em>
<a class="reference external" href="https://dx.doi.org/10.4310/CAG.2020.v28.n2.a2">https://dx.doi.org/10.4310/CAG.2020.v28.n2.a2</a></p>
</div>
</div>
</dd></dl>
...
<dd><p>The faces are the complementary regions of the link diagram.
Each face is given as a list of corners of crossings as one
goes around <em>clockwise</em>.  These corners are recorded as
CrossingStrands, where CrossingStrand(c, j) denotes the corner
of the face abutting crossing c between strand j and j + 1.</p>
...
<dl class="py method">
<dt class="sig sig-object py" id="spherogram.Link.many_diagrams">
<span class="sig-name descname"><span class="pre">many_diagrams</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">target</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">10</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">tries</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">100</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">method</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">'backtrack'</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#spherogram.Link.many_diagrams" title="Link to this definition"></a></dt>
<dd><p>Try to generate <code class="docutils literal notranslate"><span class="pre">target</span></code> distinct diagrams of the given link,
each of which has been simplified with <code class="docutils literal notranslate"><span class="pre">mode='global'</span></code>.</p>
<p>The two methods are:</p>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">backtrack</span></code>: Does 100 random Reidemeister I, II, and III
moves and then simplifies.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">exterior</span></code>: Takes the exterior of the link and then applies
SnapPy’s <code class="docutils literal notranslate"><span class="pre">exterior_to_link</span></code> to that triangulation to get a
new diagram.</p></li>
</ul>
<p>Both methods involve much randomziation, and the <code class="docutils literal notranslate"><span class="pre">tries</span></code>
argument is the maximum number of link diagrams considered in
hopes of finding <code class="docutils literal notranslate"><span class="pre">target</span></code> distinct ones.</p>
<p>The diagrams returned are moreover required to have
non-isomorphic <a class="reference internal" href="#spherogram.Link.dual_graph" title="spherogram.Link.dual_graph"><code class="xref py py-meth docutils literal notranslate"><span class="pre">dual</span> <span class="pre">graphs</span></code></a>.  A copy
of the initial diagram is always included in the links
returned.</p>
<div class="doctest highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">K</span> <span class="o">=</span> <span class="n">Link</span><span class="p">(</span><span class="s1">&#39;K8n1&#39;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">len</span><span class="p">(</span><span class="n">K</span><span class="o">.</span><span class="n">many_diagrams</span><span class="p">(</span><span class="n">target</span><span class="o">=</span><span class="mi">2</span><span class="p">))</span>
...
<dl class="py method">
<dt class="sig sig-object py" id="spherogram.Link.ribbon_concordant_links">
<span class="sig-name descname"><span class="pre">ribbon_concordant_links</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">max_bands</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">1</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">max_twists</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">2</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">max_band_len</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">paths</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">'shortest'</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">filter_for_plausibly_slice</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">True</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">certificates</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">False</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">print_progress</span></span><span class="o"><span class="pre">=</span></span><span class="default_value"><span class="pre">False</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#spherogram.Link.ribbon_concordant_links" title="Link to this definition"></a></dt>
<dd><p>Given a link L_0, generate ribbon concordant links L_i.  Here,
each L_i is obtained from L_0 by adding bands and deleting any
unknotted and unlinked components.  The arguments include:</p>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">max_bands</span></code>: The maximum number of bands to attach.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">max_twists</span></code> and <code class="docutils literal notranslate"><span class="pre">max_band_len</span></code> specify now complicated
each band can be.  Here the length of a band is the number
of strands of the link it crosses plus 2.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">paths=='shortest'</span></code> means the band must represent a
shortest-length path in the dual 1-skeleton to the link
diagram.  Having <code class="docutils literal notranslate"><span class="pre">paths=='simple'</span></code> allows the band to
follow any simple path.</p></li>
<li><p>When <code class="docutils literal notranslate"><span class="pre">filter_for_plausibly_slice</span></code> is <code class="docutils literal notranslate"><span class="pre">True</span></code>, it only
...
<a class="reference internal" href="censuses.html#snappy.RibbonLinks" title="snappy.RibbonLinks"><code class="xref py py-class docutils literal notranslate"><span class="pre">snappy.RibbonLinks</span></code></a> to short cut to the unknot.</p></li>
<li><p>When <code class="docutils literal notranslate"><span class="pre">certificates</span></code> is <code class="docutils literal notranslate"><span class="pre">True</span></code>, it returns a
...
<code class="docutils literal notranslate"><span class="pre">spherogram.links.bands.verify_ribbon_to_unknot</span></code>.</p></li>
</ul>
<p>Note: For ease of identification, the unknot is returned as a string:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">sage</span><span class="p">:</span> <span class="n">L</span> <span class="o">=</span> <span class="n">Link</span><span class="p">(</span><span class="s1">&#39;K6a3&#39;</span><span class="p">)</span>
<span class="n">sage</span><span class="p">:</span> <span class="n">L</span><span class="o">.</span><span class="n">ribbon_concordant_links</span><span class="p">(</span><span class="n">max_twists</span><span class="o">=</span><span class="mi">1</span><span class="p">)</span>   <span class="c1">#doctest: +SNAPPY</span>
<span class="p">[</span><span class="s1">&#39;unknot&#39;</span><span class="p">]</span>
</pre></div>
</div>
<p>An example of acceleration using <a class="reference internal" href="censuses.html#snappy.RibbonLinks" title="snappy.RibbonLinks"><code class="xref py py-class docutils literal notranslate"><span class="pre">snappy.RibbonLinks</span></code></a>.
This knot has fusion number 2, but we detect that it is ribbon
with by adding a single band and getting a known ribbon link:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">sage</span><span class="p">:</span> <span class="n">L</span> <span class="o">=</span> <span class="n">Link</span><span class="p">(</span><span class="s1">&#39;DT[papbdGaHImCEopnfklj]&#39;</span><span class="p">)</span>  <span class="c1"># This is 16n61264</span>
<span class="n">sage</span><span class="p">:</span> <span class="n">cert</span> <span class="o">=</span> <span class="n">L</span><span class="o">.</span><span class="n">ribbon_concordant_links</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="mi">2</span><span class="p">,</span> <span class="n">certificates</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>  <span class="c1">#doctest: +SNAPPY</span>
<span class="n">sage</span><span class="p">:</span> <span class="n">cert</span><span class="p">[</span><span class="s1">&#39;unknot&#39;</span><span class="p">][</span><span class="o">-</span><span class="mi">1</span><span class="p">]</span>                                            <span class="c1">#doctest: +SNAPPY</span>
<span class="s1">&#39;ribbon_2_10_7ecd0dc0&#39;</span>
</pre></div>
</div>
<p>See Section 2 of <a class="reference external" href="https://arXiv.org/abs/2512.21825">[Dunfield and Gong]</a>
for more details.</p>
</dd></dl>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">sage</span><span class="p">:</span> <span class="n">B</span> <span class="o">=</span> <span class="n">BraidGroup</span><span class="p">(</span><span class="mi">4</span><span class="p">)</span>
<span class="n">sage</span><span class="p">:</span> <span class="n">a</span><span class="p">,</span> <span class="n">b</span><span class="p">,</span> <span class="n">c</span> <span class="o">=</span> <span class="n">B</span><span class="o">.</span><span class="n">gens</span><span class="p">()</span>
<span class="n">sage</span><span class="p">:</span> <span class="n">Link</span><span class="p">(</span><span class="n">braid_closure</span><span class="o">=</span><span class="p">(</span><span class="n">a</span><span class="o">**-</span><span class="mi">3</span><span class="p">)</span> <span class="o">*</span> <span class="p">(</span><span class="n">b</span><span class="o">**</span><span class="mi">4</span><span class="p">)</span> <span class="o">*</span> <span class="p">(</span><span class="n">c</span><span class="o">**</span><span class="mi">2</span><span class="p">)</span> <span class="o">*</span> <span class="n">a</span> <span class="o">*</span> <span class="n">b</span> <span class="o">*</span> <span class="n">c</span> <span class="p">)</span>
<span class="o">&lt;</span><span class="n">Link</span><span class="p">:</span> <span class="mi">2</span> <span class="n">comp</span><span class="p">;</span> <span class="mi">12</span> <span class="n">cross</span><span class="o">&gt;</span>
...
<em class="property"><span class="k"><span class="pre">class</span></span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">spherogram.</span></span><span class="sig-name descname"><span class="pre">ClosedBraid</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="o"><span class="pre">*</span></span><span class="n"><span class="pre">args</span></span></em>, <em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">kwargs</span></span></em><span class="sig-paren">)</span><a class="headerlink" href="#spherogram.ClosedBraid" title="Link to this definition"></a></dt>
