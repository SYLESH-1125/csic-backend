...
import { EvidenceBlockNode,
      type EvidenceBlockAttrs } from '@/components/tiptap'
import { ClaimNode } from '@/components/tiptap/extensions/ClaimNode'
import { FloatingToolbar } from '@/components/studio-v4/toolbar/FloatingToolbar'
